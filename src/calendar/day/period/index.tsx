...
const PeriodDay = (props) => {
    ...
    const markingStyle = useMemo(() => {
        ...
        if (!marking) {
            ...
            if (marking.disabled) {
              defaultStyle.textStyle = { color: '#909090' };
              defaultStyle.containerStyle = { backgroundColor : '#F0F0F0', 
                width: 34, height: 34
              }
            }
    ...
    const containerStyle = useMemo(() => {
        ...
        if (state === 'today') {
            ...
            containerStyle.push({ backgroundColor: '#fff' , width: 34, height: 34,    borderWidth: 1, borderColor: '#13A872', borderRadius: 34,
        ...
        if (marking) {
            ...
            if (start && !end) {
                ...
                containerStyle.push({ backgroundColor: '#13A872' , width: 34, height: 34});
            }
